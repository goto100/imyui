...
-->			<li><a href="../news/news.asp?cateId=2">Aktuell</a></li>
		...
		<ul id="subNav-contact">
			<li><a href="locations.asp">Anschrift</a></li>
...
<h1><!-- InstanceBeginEditable name="title" -->Kontakt<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>Sie erreichen uns per Email under folgender Adresse:</p>
	<p>m.mitzscher@richter-international.com（MAILTO）</p>
	<p>Nutzen Sie alternative unser Kontaktformular:</p>
	<p>Same design, to m.mitzscher@richter-international.com</p>
