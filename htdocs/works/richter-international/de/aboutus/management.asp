...
<h1><!-- InstanceBeginEditable name="title" -->Associates, Details from name card<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<dl>
		<dt>Assistentin der GL</dt>
		<dd>to be confirmed (tbc)</dd>
		<dt>Vertrieb & Marketing</dt>
		<dd>Matthias Mitzscher</dd>
		<dt>Produktion</dt>
		<dd>tbc</dd>
		<dt>Lager/Versand</dt>
		<dd>tbc</dd>
