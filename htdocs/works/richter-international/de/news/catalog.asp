...
<h1><!-- InstanceBeginEditable name="title" -->Katalog<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>Wir freuen uns, Ihnen auch in diesem Jahr zukunftsweisende Neuentwicklungen aus der breitgefaecherten Welt von Richter-International vorstellen zu koennen.</p>
	<p>Ueberzeugen Sie sich von der Anwendungsvielfalt und den unterschiedlichsten Moeglichkeiten fuer Ihre Promotionsartikel oder Inneneinrichtung.</p>
	<p>Fuer mehr Informationen klicken Sie auf das Bild (size)</p>
