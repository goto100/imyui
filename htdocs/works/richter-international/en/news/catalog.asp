...
<h1><!-- InstanceBeginEditable name="title" -->Catalog<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>We are pleased to offer you some more exciting new developments from Richter-International’s world of sourcing.</p>
	<p>You’ll be amazed by the wide variety of products.</p>
	<p>Please click on the picture for more information (file size).</p>
	<p>3 options: promotional articles, bamboo flooring, lighting; all of them with subtitles.</p>
