...
-->			<li><a href="../news/news.asp?cateId=1">News</a></li>
		...
		<ul id="subNav-products">
			...
			<li><a href="bambooflooring/default.asp">Bamboo Flooring</a></li>
...
<h1><!-- InstanceBeginEditable name="title" -->Promotional Articles<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<ul>
		<li>Nylon &amp; Textiles</li>
		<li>Fun &amp; Games</li>
		<li>Activity &amp; Sports</li>
		<li>Technical Products</li>
		<li>Tools</li>
		<li>Cars &amp; Travel</li>
		<li>Wood, Leather &amp; Plush</li>
		<li>Office</li>
		<li>Dining</li>
	</ul>
