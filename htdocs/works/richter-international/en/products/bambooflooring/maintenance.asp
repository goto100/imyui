...
<h1><!-- InstanceBeginEditable name="title" -->Maintenance<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>Like any other natural wood flooring, bamboo flooring has to be taken care of: </p>
	<ol type="a">
		<li>Flooring should not be soaked with water. If it is exposed to large amounts of water, dry it immediately to avoid swelling and open the window to let fresh air in.</li>
		<li>Use a vacuum cleaner and a dry mop to clean. Use floor wax to protect it.</li>
		<li>Heavy items such as furniture, piano, etc. must not be dragged across the floor. Use protective cloth on their standings.</li>
		<li>Avoid degrading materials to reach the floor, like sand and shoe nails.</li>
		<li>The floor should not be exposed directly to sunlight or some electric heaters.</li>
	</ol>
