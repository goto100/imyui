...
-->			<li><a href="career.asp">Stellenangebote</a></li>
<!--			<li><a href="../de/news/pressreleases.asp">Pressemitteilungen (tbc)</a></li>
-->			<li><a href="news.asp?cateId=2">Aktuell</a></li>
		</ul>
...
<h1><!-- InstanceBeginEditable name="title" -->Stellenangebote<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>Richter-International ist ein schnell wachsendes und dynamisches Unternehmen, das auf qualifiziertem Personal beruht. In den einzelnen Standorten sucht Richter-International ständig neue Mitarbeiter.</p>
	<p>Initiativbewerbungen sind bei uns jederzeit willkommen!</p>
	<p>Richten Sie Ihre Bewerbung per Post oder Email an:</p>
	<p>Address from name card, email hong cai</p>
