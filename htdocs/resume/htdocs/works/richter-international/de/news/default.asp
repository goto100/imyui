...
<h1><!-- InstanceBeginEditable name="title" -->Aktuell<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
		<ul>
			<li><a href="catalog.asp">Katalog (tbc)</a></li>
			<li><a href="career.asp">Stellenangebote</a></li>
			<li><a href="pressreleases.asp">Pressemitteilungen (tbc)</a></li>
			<li><a href="news.asp?cateId=2">Aktuell</a></li>
		</ul>
