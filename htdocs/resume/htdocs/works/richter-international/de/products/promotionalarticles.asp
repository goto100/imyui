...
<h1><!-- InstanceBeginEditable name="title" -->Promotionsartikel<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<ul>
		<li>Nylon &amp; Textilien</li>
		<li>Spiel &amp; Spass</li>
		<li>Sport</li>
		<li>Technische Produkte</li>
		<li>Werkzeuge</li>
		<li>Auto &amp; Resien</li>
		<li>Holz, Leder und Pluesch</li>
		<li>Buero</li>
		<li>Haushalt</li>
	</ul>
