...
<h1><!-- InstanceBeginEditable name="title" -->Environementally Friendly Products<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>Global forestry is one reason why local environments and climatic patterns are continually destabilizing. For this reason, programs such as recycling  are becoming popular to curb the degradation. Alternatives to timber as a construction material have also been promoted to reduce dependence on hardwoods. With its physical characteristics and ability to regenerate rapidly, bamboo is one of the best means to replace hardwoods while providing similar properties and attractiveness. At present, demand for our bamboo products is steadily growing in Western Europe, North America and Japan.</p>
	<p>Mao bamboo also benefits the environment in which it grows. For example, its broad root structure helps to stabilize the soil and prevent erosion.</p>
