...
<!-- InstanceParam name="id2" type="text" value="bamboo" -->
<link href="../../../style/style.css" rel="stylesheet" type="text/css" />
</head>

<body id="page-products" class="en">
<div id="Wrapper">
<div id="InnerWrapper">
...
-->			<li><a href="../../news/news.asp?cateId=1">News</a></li>
		...
		<ul id="subNav-products">
			<li><a href="../promotionalarticles.asp">Promotional Articles</a></li>
			<li><a href="default.asp">Bamboo Flooring</a></li>
			<li><a href="../lighting.asp">Lighting</a></li>
			<li><a href="../rawmaterials.asp">Raw Materials</a></li>
		</ul>
...
<h1><!-- InstanceBeginEditable name="title" -->Products Introduction<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>Bamboo use in China extends over 4,000 years ago. Many ancient cultural bamboo artifacts were made for daily production and living purposes. The history and usage of bamboo dishes and musical instruments is especially extensive. Before paper was developed, Chinese people used bamboo flakes as a way to record history and spread culture. The flexibility and durability of bamboo products is what made this material very popular and reliable.</p>
	<p>China is relatively poor in hardwood but is one of the few countries that are rich in bamboo resources. China is the largest producer of bamboo products in the world. Bamboo grows mainly in South China and covers areas over 1.6 million square miles.</p>
	<p>Traditionally, bamboo was only used for daily accessories, such as chopsticks, cups, chairs, etc. During the 1990s, bamboo production technology developed greatly. Due to economic growth in China, deforestation became an important issue. Bamboo began to attract attention from the government and public as an alternative building material. In southern China, rich soil and plentiful precipitation allowed for a friendly tropical environment in which to grow bamboo.</p>
	<p>Bamboo harvesting provides a sole means of making a living for many bamboo farmers in the poor mountainous regions in the south. This bamboo industry is also supported and encouraged by the local government.</p>
...
<div id="Sidebar">
	...
	<div id="quickBar">
		<ul id="quickBar-products">
			<li><a href="aboutbamboo.asp">About Bamboo</a></li>
			<li><a href="bamboocharacteristics.asp"> Bamboo Characteristics</a></li>
			<li><a href="environementallyfriendlyproducts.asp">Environmentally Friendly Products</a></li>
			<li><a href="productsintroduction.asp">Product Introduction</a></li>
