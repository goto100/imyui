...
<h1><!-- InstanceBeginEditable name="title" -->News<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
		<ul>
<!--			<li><a href="catalog.asp">Catalog (tbc)</a></li>
-->			<li><a href="career.asp">Career opportunities</a></li>
<!--			<li><a href="pressreleases.asp">Press released (tbc)</a></li>
