...
<h1><!-- InstanceBeginEditable name="title" -->Contact<!-- InstanceEndEditable --></h1>
<div id="ContentWrapper">
<div id="Content">
	<!-- InstanceBeginEditable name="content" -->
	<p>You can reach us by email at:<br />
	m.mitzscher@richter-international.com<br />
	Alternatively you can use our contact form!</p>
