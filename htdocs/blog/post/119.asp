        <%ST(A)%>
			<div id="Content_ContentList" class="content-width"><a name="body" accesskey="B" href="#body"></a>
				<div class="pageContent">
					<div style="float:right;width:180px !important;width:auto"><a href="?id=118" title="上一篇日志: 搞死Maxthon有多容易？" accesskey=","><img border="0" src="images/Cprevious.gif" alt=""/>上一篇</a> | <a href="?id=120" title="下一篇日志: 一个典型网页设计师的情书[转]" accesskey="."><img border="0" src="images/Cnext.gif" alt=""/>下一篇</a></div> 
				...
				<div class="Content">
					...
					<h1 class="ContentTitle"><strong>人面兽心</strong></h1>
					<h2 class="ContentAuthor">作者:宇义 日期:2005-12-13</h2>
				</div>
				...
				<div id="logPanel" class="Content-body">
					人面兽心应该是一个褒义词，现在还有比人类更加邪恶的动物么？
					<br/><br/><br/>
				</div>
				<div class="Content-body">
					
					<img src="images/From.gif" style="margin:0px 2px -4px 0px" alt=""/><strong>文章来自:</strong> <a href="#" target="_blank">本站原创</a><br/>
					<img src="images/icon_trackback.gif" style="margin:4px 2px -4px 0px" alt=""/><strong>引用通告:</strong> <a href="trackback.asp?tbID=119&amp;action=view" target="_blank">查看所有引用</a> | <a href="javascript:;" title="获得引用文章的链接" onclick="getTrackbackURL(119)">我要引用此文章</a><br/>
					<img src="images/tag.gif" style="margin:4px 2px -4px 0px" alt=""/><strong>Tags:</strong> <br/>
				</div>
				<div class="Content-bottom"><div class="ContentBLeft"></div><div class="ContentBRight"></div>评论: 0 | <a href="trackback.asp?tbID=119&amp;action=view" target="_blank">引用: 1142</a> | 查看次数: <$log_ViewNums$></div>
			</div>
		</div>
