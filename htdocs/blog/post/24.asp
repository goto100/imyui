        <%ST(A)%>
			<div id="Content_ContentList" class="content-width"><a name="body" accesskey="B" href="#body"></a>
				<div class="pageContent">
					<div style="float:right;width:180px !important;width:auto"><a href="?id=23" title="上一篇日志: 今天又做了一张图" accesskey=","><img border="0" src="images/Cprevious.gif" alt=""/>上一篇</a> | <a href="?id=25" title="下一篇日志: 今天的作品" accesskey="."><img border="0" src="images/Cnext.gif" alt=""/>下一篇</a></div> 
				...
				<div class="Content">
					...
					<h1 class="ContentTitle"><strong>哈哈，再来一张~</strong></h1>
					<h2 class="ContentAuthor">作者:宇义 日期:2004-09-01</h2>
				</div>
				...
				<div id="logPanel" class="Content-body">
					在赢政论坛灌水时发现一个网友的头像，一个小灯泡。于是拿来练练手~看看像不像？<br/>原图：<br/><img src="attachments/month_200409/01_005737_jg9n386151.gif" border="0" alt=""/><br/>偶做的~<br/><img src="attachments/month_200409/01_012041_3zr6.png" border="0" alt=""/>
					<br/><br/><br/>
				</div>
				...
				<div class="Content-bottom"><div class="ContentBLeft"></div><div class="ContentBRight"></div>评论: 0 | <a href="trackback.asp?tbID=24&amp;action=view" target="_blank">引用: 276</a> | 查看次数: <$log_ViewNums$></div>
			</div>
		</div>
